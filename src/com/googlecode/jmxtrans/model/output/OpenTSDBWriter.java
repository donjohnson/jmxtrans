...
/**
 * This output writer sends data to a host/port combination in the OpenTSDB
 * format.
 *
 * @see <a href="http://opentsdb.net/getting-started.html">OpenTSDB Getting Started</a>
 *
 * @author jon
 */
				...
				if (resultValues != null) {
					for (Entry<String, Object> values : resultValues.entrySet()) {
						if (JmxUtils.isNumeric(values.getValue())) {
							...
							sb.append(" ");
							sb.append(JmxUtils.getTagsTSD(query, result, values, typeNames, rootPrefix));
							sb.append("\n");

							String line = sb.toString();
							if (isDebugEnabled()) {
								log.debug("OpenTSDB Message: " + line.trim());
							}
							writer.write(line);
							writer.flush();
						}
